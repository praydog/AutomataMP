...
public:
    ...
    auto get_last_window_pos() const { return m_last_window_pos; } // AutomataMP imgui window
...
extern std::unique_ptr<AutomataMP> g_framework;
